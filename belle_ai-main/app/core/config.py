...
class Settings(BaseSettings):
    ...
    # Database settings
    database_url: str = (
        "mysql+pymysql://root:password@localhost:3306/belle_ai?charset=utf8mb4"
    )
    ...
    intent_min_stay_for_high: int = (
        60  # Minimum stay time for high intent (with strong signals)
    )
